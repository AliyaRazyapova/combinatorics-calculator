...
def perestanovki_repeat_list():
    ...
    if k:
        try:
            ...
            return render_template('perestanovki_repeat.html', error=error)
    else:
        ...
        try:
            ...
            if sm>0:
                ...
                return render_template('perestanovki_repeat.html', response=response)
            else:
...
def perestanovki_not_repeat_list():
    ...
    if num:
        try:
            ...
            error = 'Введите корректны данные'
